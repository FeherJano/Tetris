...
public class Shape {
    ...
    public void reset() {
     ...
     public void update() {
         ...
         boolean moveX = true;
         //check if the piece is within the border limits
     ...
     public void rotateShape() {
        ...
        //check for right side and bottom, to not rotate out of the board
        if ((x + rotatedShape[0].length > Board.BOARD_WIDTH) || (y + rotatedShape.length > BOARD_HEIGHT)) {
            return;
        }
